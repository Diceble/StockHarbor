...
namespace StockHarbor.Domain.Migrations
{
    ...
    partial class StockHarborDatabaseContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("StockHarbor.Domain.Entities.ProductVariant", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityAlwaysColumn(b.Property<int>("ProductVariantId"));
